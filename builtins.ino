...
void NewKITTStub() { NewKITT(0xff,0,0,8,10,50); }
...
void RunningLightsWhite() { RunningLights(0xff,0xff,0xff, 50); } // white 
void RunningLightsBlue() {  RunningLights(0,0,0xff, 50);       } // blue 
void RunningLightsRed() {  RunningLights(0xff,0,0, 50);       } // red 
